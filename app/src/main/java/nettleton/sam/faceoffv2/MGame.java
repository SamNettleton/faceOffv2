...
public class MGame extends Activity implements View.OnClickListener{
    DrawView drawView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m_setup);
    ...
    private void handleException(Exception exception, String details) {
        ...
        new AlertDialog.Builder(MGame.this)
                .setTitle("Error")
                .setMessage(message + "\n" + errorString)
    ...
    private void onConnected(GoogleSignInAccount googleSignInAccount) {
        ...
        if (mSignedInAccount != googleSignInAccount) {
            ...
            mInvitationsClient = Games.getInvitationsClient(MGame.this, googleSignInAccount);
        ...
        GamesClient gamesClient = Games.getGamesClient(MGame.this, googleSignInAccount);
